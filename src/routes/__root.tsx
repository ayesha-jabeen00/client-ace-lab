...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Northwind — Performance Marketing Agency" },
      { name: "description", content: "Data-driven digital marketing agency helping brands scale with SEO, paid ads, and creative that converts." },
      { name: "author", content: "Northwind Agency" },
